            ...
            child: Column(
              ...
              children: <Widget>[
                ...
                Row(
                  ...
                  children: <Widget>[
                    Text("Forgotten Password?", style: TextStyle(fontSize: 18.0, fontWeight: FontWeight.bold, color: Colors.blueAccent),),
                  ],
                ),
                ...
                Container(
                  ...
                  child: Center(
                    child: Text("Sign In", style: TextStyle(fontSize: 18.0, fontWeight: FontWeight.bold, color: Colors.white),),
                  ),
                ),
                Divider(height: 20.0,),
                Row(
